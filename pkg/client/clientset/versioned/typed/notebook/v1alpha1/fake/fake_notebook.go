...
type FakeNotebooks struct {
	Fake *FakeNotebookV1alpha1
	ns   string
}

var notebooksResource = schema.GroupVersionResource{Group: "notebook", Version: "v1alpha1", Resource: "notebooks"}

var notebooksKind = schema.GroupVersionKind{Group: "notebook", Version: "v1alpha1", Kind: "Notebook"}
...
func (c *FakeNotebooks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Notebook, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(notebooksResource, c.ns, name, data, subresources...), &v1alpha1.Notebook{})
